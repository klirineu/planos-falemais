        ...
        <Data>
          ...
          <DataGroup fontSize="25px">
            ...
            <Description data-testid="comFaleMais" color="#00E396">
              {`R$ ${!Number.isNaN(precos.comFaleMais) ? precos.comFaleMais.toFixed(2) : alert("'Origem e destino incompatíveis com o plano escolha novamente")}`}
            </Description>
          </DataGroup>
          <DataGroup>
            <Label color="#ff0000">Sem FaleMais:</Label>
            <Description data-testid="semFaleMais" color="#ff0000">
              {`R$ ${!Number.isNaN(precos.semFaleMais) ? precos.semFaleMais.toFixed(2) : alert("'Origem e destino incompatíveis com o plano escolha novamente")}`}
            </Description>
          </DataGroup>
        </Data>
